...
struct CONTENT_EXPORT FencedFrameProperties {
  ...
  // Whether this is an ad component fenced frame. Note there is no
  // corresponding field in `RedactedFencedFrameProperties`. This flag is needed
  // to enable automatic reportEvent beacon support for ad component.
  bool is_ad_component_ = false;
};
